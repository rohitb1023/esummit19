 	...
 	function counting (){
 		if(temp<=200){
 			setTimeout(function(){
 				...
 				setTimeout(function(){
 					document.getElementById('counter').innerText=200;
 				},40)
 			}
 		}
 	...
 	function counting1 (){
 		if(temp1<=20){
 			setTimeout(function(){
 				...
 				setTimeout(function(){
 					document.getElementById('counter1').innerText=20;
 				},120)
 			}
 		}
 	...
 	function counting3 (){
 		if(temp3<=6){
 			setTimeout(function(){
 				...
 				setTimeout(function(){
 					document.getElementById('counter3').innerText=6;
 				},200)
 			}
 		}
